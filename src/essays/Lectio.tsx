...
hallitsevimpia teemoja ja monet hänen tunnetuimmista runoistaankin ovat ars poetica -runoutta, säemuotoista runousoppia.
        ...
        <p>
            ...
            joka hallitsi suomalaista sotienjälkeistä kirjallista elämää. Erään modernismin määritelmän mukaan modernistisen kirjallisuuden
            innovaatiot heijastavat 1900-luvun alun tieteissä ja taiteissa tapahtunutta murrosta, jonka seurauksena niin sanotut suuret
        ...
        <p>
            ...
            assosiatiivisesta ja fragmentaarisesta modernistisesta runosta. Kuten aiemmin todettu, mitan suhteen Viita oli lopultakin hyvin
            vapaamielinen; hän kirjoitti niin proosarytmistä, vapaamittaista kuin mitallistakin runoutta. Se, ettei hän hylännyt tiukasti
            säädeltyä mittaa, on kuitenkin osoitus hänen vastahankaisesta suhteestaan muodon vallankumousta julistavaan modernistiseen
            estetiikkaan. Vielä enemmän kuin mitallisuus, perinteiseen runomuotoon Viidan kytkee hänen runojensa äärimmilleen hiottu
        ...
        <p>
            ...
            tarkoitus on luoda hetkeksi mukava tunnelma. Runo ilmaisee Viidan runoilijahahmojen todellisia ja vakavasti otettavia toiveita.
            Hekin haluavat ”kohota unessa pilvien alta ja katsella korkeammalta”.
        </p>
        <p>
            Unilla on merkittävä rooli Viidan runoilijahahmojen pyrkimyksissä koota maailma jälleen harmoniseksi kokonaisuudeksi. ”Alfhild”
            kuvaa puhujan äidin unessa tekemää matkaa taivaaseen, jossa mennyt ja nykyhetki elävät rinnan eikä mikään kaunis ole kadonnut.
            Taivaassa Alfhild tapaa edesmenneen miehensä Eemelin, ja yhdessä he katselevat alas Pispalan ”kotoista mäkeä” ja muistelevat
            nuoruusvuosiaan. Herättyään Alfhild levittää uniensa ilosanomaa ympärilleen ja julistaa taivaan ja maan suuruutta, joka
            hänellä on intuitiivinen kyky käsittää: ”Oi kuinka on ihana elää ja tuutia lastenlapsiaan ja kertoa kauniita uniaan! Niin
        ...
        <p>
            ...
            luopumaan uskostaan unissa nähtyyn luvattuun maahan. Kuolema perustelee kantaansa viittaamalla tieteellisen maailmankuvan
            peruspilareihin, Freudin psykoanalyysiin, Marxin materialismiin ja Einsteinin suhteellisuusteoriaan, ja lopulta voittaa
            kamppailun. Runoilija hukkuu järkensä pyörteisiin, ja maailma jää sirpaleiseksi ja elottomaksi.
        </p>
        <p>
            ”Betonimylläri”-runon lopputulos on toinen. Puhuja, työmaalla työskentelevä betonimylläri, vaipuu lounastauollaan uneen, ja kun
            hän herää, ennen eloton aine on saanut jumalallisen ulottuvuuden: ”ainein kolmiyhteisin loihdin lujan betonin”. Unissaan
        ...
        <p>
            ...
            luomisprosessin kannalta: runo päättyy siihen, kun pastori nappaa unestaan Sanan, josta hänen saarnansa saa alkunsa.
        </p>
        <p>
            Antimodernisti ei ole irrallaan modernismista vaan aivan sen ytimessä. Sen tietää siitä, että hän kärsii asemastaan ja
        ...
        <p>
            ...
            näkijään, joka on varhaisimpia käsityksiä siitä, mikä on runoilija ja mitkä hänen tehtävänsä ovat. Visionaarinen runoilija,
            vates, toimii välittäjänä maailman ja korkeimpien voimien välillä. Hän rinnastuu esimerkiksi psalmien laulajiin, jotka puhuvat
            Jumalan hengen inspiroimana, tai pappiin, joka saa sanansa ja samalla arvovallan puhua Jumalalta. Edellä mainittu ”Kesäyö”-runon
            pastori on vates-hahmon arkinen muunnelma. Hänkin tavoittelee transsendenssin kokemusta voidakseen välittää yleisölleen ”jotakin
        ...
        <p>
            ...
            ”vallan mainioksi mieheksi”.
        </p>
        <p>
            50-luvun runoilijakäsitykseen kuului ajatus tekstin autonomisuudesta suhteessa tekijäänsä: runoilijalla historiallisena
            henkilönä ei ollut enää merkitystä, kun runo oli valmis ja lukijoiden käsissä. Viidan käsitys oli täysin päinvastainen.
            ”Alfhild”-runossa on jälleen paljonpuhuva säe: ”Alfhild, hän joka synnytti minut”. Kirjallisuudentutkija ei voi täysin
            samastaa tekijää ja tekstiä. Hän ei voi väittää, että kerran lihaa ja verta ollut Lauri Viita ajatteli niin kuin runoissaan
            kirjoitti. Runojen puhujat saavat kuitenkin tehdä, mitä haluavat, ja ”Alfhild”-runon puhuja julistautuu runoilija Lauri
            Viidaksi, Pispalassa varttuneeksi historialliseksi henkilöksi, jonka Alfhild-niminen henkilö synnytti tähän maailmaan.
            Häpeilemättä puhuja ohittaa väitteet tekstin autonomisuudesta suhteessa tekijäänsä ja väittää olevansa enemmän kuin
        ...
        <p>
            Muodoltaan Viidan runous kyllä muistuttaa sotaa edeltävää perinteistä runoutta, mutta Viita ei ole samalla tavalla
            perinteinen kuin sotaa edeltävät runoilijat. Uudestaan ja uudestaan hän kohtaa samat ongelmat kuin hänen aikalaisensa
            mutta itsepintaisesti päättää uskoa maailmaan, joka on kaunis, elävä ja harmoninen. Muoto heijastaa ajattelutapoja ja
